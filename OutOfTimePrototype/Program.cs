...
class Program
{
    private static void Main()
    {
        ...
        {
            new(ClaimTypes.Name, "ya-hue-sos"),
            new(ClaimTypes.Email, "suka@ebal.rot"),
            new(ClaimTypes.Role, "Pidor"),
            new(ClaimTypes.Role, "Mraz")
        };
        ...
        var roles = tokenOptions.Claims.Where(c => c.Type == ClaimTypes.Role).ToList();
    }
}