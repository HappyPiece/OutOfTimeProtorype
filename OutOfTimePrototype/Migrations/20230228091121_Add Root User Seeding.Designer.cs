            ...
            modelBuilder.Entity("OutOfTimePrototype.DAL.Models.Educator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("64f29e16-283a-49af-a52a-906a2b16b515"),
                            FirstName = "Educator",
                            LastName = "Educatorov",
                        ...
                        new
                        {
                            Id = new Guid("0322ca1f-2d3c-4759-8cbb-17f839785cd8"),
                            FirstName = "Prepod",
                            LastName = "Prepodov",
            ...
            modelBuilder.Entity("OutOfTimePrototype.DAL.Models.TimeSlot", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Number = 1,
                            EndTime = new DateTime(2023, 2, 28, 3, 20, 0, 0, DateTimeKind.Utc),
                            StartTime = new DateTime(2023, 2, 28, 1, 45, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Number = 2,
                            EndTime = new DateTime(2023, 2, 28, 5, 10, 0, 0, DateTimeKind.Utc),
                            StartTime = new DateTime(2023, 2, 28, 3, 35, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Number = 3,
                            EndTime = new DateTime(2023, 2, 28, 7, 0, 0, 0, DateTimeKind.Utc),
                            StartTime = new DateTime(2023, 2, 28, 5, 25, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Number = 4,
                            EndTime = new DateTime(2023, 2, 28, 9, 20, 0, 0, DateTimeKind.Utc),
                            StartTime = new DateTime(2023, 2, 28, 7, 45, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Number = 5,
                            EndTime = new DateTime(2023, 2, 28, 11, 10, 0, 0, DateTimeKind.Utc),
                            StartTime = new DateTime(2023, 2, 28, 9, 35, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Number = 6,
                            EndTime = new DateTime(2023, 2, 28, 13, 0, 0, 0, DateTimeKind.Utc),
                            StartTime = new DateTime(2023, 2, 28, 11, 25, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Number = 7,
                            EndTime = new DateTime(2023, 2, 28, 14, 50, 0, 0, DateTimeKind.Utc),
                            StartTime = new DateTime(2023, 2, 28, 13, 15, 0, 0, DateTimeKind.Utc)
                        });
                });
